...
do
	...
	do
		...
		echo cpubomb_${u} >> ./result/little/t4/${u}_time.txt
		{ time ./run/cpubomb_${u} 4 ; } 2> time.txt
		cat time.txt >> ./result/little/t4/${u}_time.txt
		echo "==========" >> ./result/little/t4/${u}_time.txt
