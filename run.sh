...
do
	...
	do
		...
		echo cpubomb_${u} >> ./result/big/t2/${u}_time.txt
		{ time ./cpubomb/util/cpubomb_${u} 2 ; } 2> time.txt
		cat time.txt >> ./result/big/t2/${u}_time.txt
		echo "==========" >> ./result/big/t2/${u}_time.txt
